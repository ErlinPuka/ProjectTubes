...
<head>
   ...
   <title>Chosik Admin | Transportasi</title>
</head>
   <body>
	<div class="sidebar">
	   ...
	   <div class="home-content">
		<h3>Transportasi</h3>
			<button type="button" class="btn btn-success float-left" style="background-color: #1d528a; color: white;">
				...
				<a href="transportasi-entry">Add Data</a>
			</button>
			<br>
			<br>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th>Categories</th>
                  <th>Weight of Payload</th>
                  <th>ID Driver</th>
				  <th>Action</th>
                </tr>
				@foreach ($dttransportasi as $item)
				<tr>
					...
					<td>{{ $item->id_supir }}</td>
					<td>
						<a href="{{  url('transportasi-edit', $item->id) }}">Edit</a> | <a href="{{ url('transportasi-hapus', $item->id) }}">Delete</a>
					</td>
				</tr>
				@endforeach
                </thead>
