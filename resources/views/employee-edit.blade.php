        ...
        {{-- <div class="row"> --}}
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
				<form action="{{ url('employee-update', $peg->id) }}" method="post">
					{{  csrf_field() }}
                <div class="form-group">
                  <label for="inputName">ID Pegawai</label>
                  <input class="input" type="text" name="id_pegawai" id="id_pegawai" placeholder="ID Pegawai" value="{{ $peg->id_pegawai }}" />
                </div>
                <div class="form-group">
					<label for="inputName">Nama Pegawai</label>
					<input class="input" type="text" name="nama" id="nama" placeholder="Nama Pegawai"value="{{ $peg->nama }}" />
				  </div>

                <div class="form-group">
					<label for="inputName">Divisi</label>
					<input class="input" type="text" name="divisi" id="divisi" placeholder="Divisi" value="{{ $peg->divisi }}"/>
				  </div>
                ...
                <div class="form-group">
				  ...
				  {{-- <button type="submit" class="btn btn-success float-center" style="background-color: rgb(24, 32, 122); color: white;">
					<i class="far fa-credit-card"></i>
					<a href="employee">Simpan</a> --}}
				  </button>
              </div>
              <!-- /.card-body -->
            </div>
