        ...
        {{-- <div class="row"> --}}
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
				<form action="{{ url('jadwal-update', $peg->id) }}" method="post">
					{{  csrf_field() }}
                <div class="form-group">
                  <label for="inputName">ID Jadwal</label>
                  <input class="input" type="text" name="id_jadwal" id="id_jadwal" placeholder="ID Jadwal" value="{{ $peg->id_jadwal }}"/>
                </div>
                <div class="form-group">
					<label for="inputName">Hari Keberangkatan</label>
					<input class="input" type="date" name="hari" id="hari" value="{{ $peg->hari }}"/>
				  </div>
