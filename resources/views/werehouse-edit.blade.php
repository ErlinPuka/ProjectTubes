...
<body>
   ...
   <section class="home-section">
	...
	<div class="home-content">
	   <h3>Edit Werehouse</h3>
	   <div class="form-login">
		<form action="{{ url('werehouse-update', $peg->id) }}" method="post">
			{{  csrf_field() }}
			<label for="nama">Product Name</label>
			<input class="input" type="text" name="nama" id="nama" placeholder="Nama Produk" value="{{ $peg->nama }}" />
 
			<label for="jenis">Product Types</label>
			<input class="input" type="text" name="jenisproduk" id="jenisproduk" placeholder="Jenis Produk" value="{{ $peg->jenisproduk }}" />
 
			<label for="harga">Price</label>
			<input class="input" type="text" name="harga" id="harga" placeholder="Harga" value="{{ $peg->harga }}"/>
 
			<label for="produksi">Date of Production</label>
			<input class="input" type="date" name="produksi" id="produksi" style="margin-bottom: 20px" value="{{ $peg->produksi }}" />
 
			<label for="expired">Expiry Date</label>
			<input class="input" type="date" name="expired" id="expired" style="margin-bottom: 20px" value="{{ $peg->expire }}" />
 
			<label for="lokasi">Product Locations</label>
			<input class="input" type="text" name="lokasi" id="lokasi" placeholder="Lokasi Barang" value="{{ $peg->lokasi }}"/>
