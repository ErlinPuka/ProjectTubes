...
<head>
  ...
  <title>Chosik Admin | Drivers </title>
</head>
<body>
   <div class="sidebar">
      ...
      <div class="row">
        <div class="col-12">
          <div class="callout callout-info">
            ...
            This Page Can Only be set by the Admin
          </div>
          ...
          <div class="invoice p-3 mb-3">
            ...
            <div class="row">
              <div class="col-12">
                <h4>
                  <i class="fas fa-globe"></i> Driver PT Chosik
            ...
            <button type="button" class="btn btn-success float-left" style="background-color: #1d528a; color: white;">
              ...
              <a href="driver-entry">Add Data</a>
            </button>
              ...
              <div class="col-12 table-responsive">
                <table class="table table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{  url('driver-edit', $item->id) }}">Edit</a> | <a href="{{ url('driver-hapus', $item->id) }}">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                </thead>
