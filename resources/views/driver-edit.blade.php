...
<head>
  ...
  <title>Chosik Admin | Driver Entry</title>
</head>
<body>
   <div class="sidebar">
        ...
        {{-- <div class="row"> --}}
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
				<form action="{{ url('driver-update', $peg->id) }}" method="post">
					{{  csrf_field() }}
                <div class="form-group">
					<label for="inputName">ID Driver</label>
					<input class="input" type="text" name="id_driver" id="id_driver" placeholder="ID Driver" value="{{ $peg->id_driver }}" />
                </div>
				<div class="form-group">
					<label for="inputName">Nama Driver</label>
					<input class="input" type="text" name="nama" id="nama" placeholder="Nama Driver"value="{{ $peg->nama }}" />
				  </div>
