...
<head>
  ...
  <title>Chosik Admin | Customer Entry</title>
</head>
<body>
   <div class="sidebar">
    ...
    <div class="home-content">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
				<form action="{{ url('customer-proses') }}" method="post">
					{{  csrf_field() }}
                ...
                <div class="form-group">
					...
					<input class="input" type="text" name="nama" id="nama" placeholder="Nama Customer" />
				  </div>
