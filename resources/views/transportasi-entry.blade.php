...
<link rel="stylesheet" type="text/css" href="{{  asset('adminlte/dist/css/adminlte.min.css')}}">
   ...
   <title>Chosik Admin | Transportasi Entry</title>
</head>
<body>
   <div class="sidebar">
   ...
   <section class="home-section">
	...
	<div class="home-content">
	   <h3>Input Transportasi</h3>
	   <div class="form-login">
		<form action="transportasi-proses" method="post">
			{{  csrf_field() }}
			...
			<input class="input" type="text" name="nama" id="nama" placeholder="Nama Kendaraan" />
			
            <label for="jenis">Jenis Kendaraan</label>
			<input class="input" type="text" name="jenis" id="jenis" placeholder="Jenis Kendaraan" />
			
            <label for="berat_muatan">Berat Muatan</label>
			<input class="input" type="text" name="berat_muatan"  id="berat_muatan" placeholder="Berat Muatan"  />
