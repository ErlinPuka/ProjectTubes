...
<head>
  ...
  <title>Chosik Admin | Customer Edit</title>
</head>
<body>
   <div class="sidebar">
    ...
    <div class="home-content">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
				<form action="{{ url('customer-update', $peg->id) }}" method="post">
					{{  csrf_field() }}
                <div class="form-group">
                  <label for="inputName">ID Customer</label>
                  <input class="input" type="text" name="id_customer" id="id_customer" placeholder="ID Customer" value="{{ $peg->id_customer }}" />
                </div>
                <div class="form-group">
