...
<head>
   ...
   <title>Chosik Admin | Outlet</title>
</head>
   <body>
	<div class="sidebar">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Outlets Data Table PT Chosik</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
				...
				<tr>
					...
					<td>
						<a href="{{  url('outlet-edit', $item->id) }}">Edit</a> | <a href="{{ url('outlet-hapus', $item->id) }}">Delete</a>
					</td>
				</tr>
				@endforeach
                </thead>
