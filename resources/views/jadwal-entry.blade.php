...
<head>
  ...
  <title>Chosik Admin | Jadwal Entry</title>
</head>
<body>
   <div class="sidebar">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="inputName">ID Jadwal</label>
                  <input class="input" type="text" name="id_jadwal" id="id_jadwal" placeholder="ID Jadwal" />
                </div>
                <div class="form-group">
					<label for="inputName">Hari Keberangkatan</label>
					<input class="input" type="date" name="hari" id="hari" />
				  </div>
                ...
                <div class="form-group">
					...
					<input class="input" type="text" name="id_barang" id="id_barang" placeholder="ID Barang" />
				  </div>

				  <div class="form-group">
					<label for="inputName">ID Pengiriman</label>
					<input class="input" type="text" name="id_pengiriman" id="id_pengiriman" placeholder=" ID Pengiriman" />
				  </div>
